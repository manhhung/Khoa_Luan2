	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Loại hàng/ Cập nhật loại hàng</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Cập nhật loại hàng</div>
					<br>
					<html:form action="/capNhatLH" method="post">
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form">
							<div class="form-group">
									  <p>Mã loại hàng</p>
							          <html:text property="maLoaiHang" styleClass="form-control" readonly="true"></html:text>
							          <html:errors property="maLoaiHangError"/>
								      <br>
								</div>
								...
								<div class="form-group">
									<p>Tên loại hàng</p>
										<html:text property="tenLoaiHang" styleClass="form-control"></html:text>
									<br>
								</div>
