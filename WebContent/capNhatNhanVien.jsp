	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Nhân viên/ Cập nhật nhân viên</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<br>
					<html:form action="/capNhatNV" method="post">
						...
						<div class="col-md-6">
							<form role="form">
								...
								<div class="form-group">
									  <p>Mã nhân viên</p>
							          <html:text property="maNhanVien" styleClass="form-control" readonly = "true"></html:text>
							          <html:errors property="maNhanVienError"/>
								...
								<p>Chức vụ</p>
            							...
            							<html:optionsCollection name="nhanVienForm" property="listChucVu" label="tenChucVu" value="maChucVu" />
            							</html:select>
            					</div>
							...
							<div class="form-group">
									<p>Ngày sinh</p>
									<bean:define id="ngaySinh" name="nhanVienForm" property="ngaySinh"></bean:define>
							...
							<div class="form-group">
								...
								<div class="form-group">
								<p>Quyền hạn</p>
										<html:select property="maQuyen" styleClass="form-control">
										<option value="">-- Chọn quyền hạn --</option>
            							<html:optionsCollection name="nhanVienForm" property="listQuyen" label="tenQuyen" value="maQuyen" />
            							</html:select>
								...
								<div class="form-group">
									<p>Mật khẩu</p>
									<html:text property="matKhau" styleClass="form-control"></html:text>		            	            				
            						
								</div>					
							
							<div class="form-group">
	            				<div class="col-lg-3 col-lg-offset-9">
	               					 <html:submit styleClass="btn btn-success" property="submit" value="Lưu lại"></html:submit>
	         					 </div>
	       					</div>
							</div>
						</form>
