	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"> Đối tác/ Cập nhật nhà cung cấp</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Cập nhật nhà cung cấp</div>
					<br>
					<html:form action="/suaNCC" method="post">
					<div class="panel-body">
						<div class="col-md-6">
							...
							<div class="form-group">
							          ...
							          <html:errors property="maNCCError"/>
								      <br>
								</div>
